...
$query = "INSERT INTO mutasi (id_mutasi, nik_mutasi, nama_mutasi, tempat_lahir_mutasi, tanggal_lahir_mutasi, jenis_kelamin_mutasi, alamat_ktp_mutasi, alamat_mutasi, desa_kelurahan_mutasi, kecamatan_mutasi, kabupaten_kota_mutasi, provinsi_mutasi, negara_mutasi, rt_mutasi, rw_mutasi, agama_mutasi, pendidikan_terakhir_mutasi, pekerjaan_mutasi, status_mutasi, id_user, created_at, updated_at) VALUES (NULL, '$nik_mutasi', '$nama_mutasi', '$tempat_lahir_mutasi', '$tanggal_lahir_mutasi', '$jenis_kelamin_mutasi', '$alamat_ktp_mutasi', '$alamat_mutasi', '$desa_kelurahan_mutasi', '$kecamatan_mutasi', '$kabupaten_kota_mutasi', '$provinsi_mutasi', '$negara_mutasi', '$rt_mutasi', '$rw_mutasi', '$agama_mutasi', '$pendidikan_terakhir_mutasi', '$pekerjaan_mutasi', ', '$status_mutasi', '$id_user', CURRENT_TIMESTAMP, '0000-00-00 00:00:00.000000');";
...
if ($hasil == true) {
  echo "<script>window.alert('Mutasi warga berhasil'); window.location.href='../mutasi_/'</script>";
} else {
  echo "<script>window.alert('Mutasi warga gagal!'); window.location.href='../mutasi_/create.php?id_warga=".$id_warga."'</script>";
}
