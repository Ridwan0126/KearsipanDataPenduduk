...
<table class="table table-striped table-middle">
  ...
  <tr>
    ...
    <td>:</td>
    <td>
      <select class="form-control selectlive" name="dusun_warga" required>
  ...
  <tr>
    ...
    <td>:</td>
    <td>
      <select class="form-control selectpicker" name="rt_mutasi" required>
      ...
      <!--
      <input type="text" class="form-control" name="rt_warga" value="<?php echo $data_warga[0]['rt_warga'] ?>" readonly>
      -->
    </td>
  </tr>
  <tr>
    ...
    <td>:</td>
    <td>
    <select class="form-control selectpicker" name="rw_mutasi" required>
...
<button type="submit" class="btn btn-primary">
  <i class="fa fa-exchange fa-fw"></i> Mutasi
</button>
</form>
